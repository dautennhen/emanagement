...
Route::group(
    ...
    //vnpay
    Route::resource('vnpay', 'VNpayController');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        Route::get('billing/vnpay-download/{id}', 'SuperAdminInvoiceController@VNpayInvoiceDownload')->name('vnpay.invoice-download');
...
//                Route::get('lead-files/list', ['uses' => 'LeadFilesController@list'])->name('lead-files.list');
                ...
                Route::get('project-template-get-member/{id}', 'ProjectMemberTemplateController@getMemberByTemplateId');
            ...
            Route::group(['middleware' => ['account-setup']], function () {
                ...
                //vnpay payment
                Route::post('/vnpay', 'VNpayController@redirectToGateway')->name('payments.vnpay');
                Route::get('vnpay/payment/callback', 'VNpayController@handleGatewayCallback')->name('payments.vnpay.callback');
