...
class User extends BaseModel implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    //lọc danh sách clients có project
    public static function allClientsWithProject()
    {
        $clients = ClientDetails::join('users', 'client_details.user_id', '=', 'users.id')
            ->join('projects','client_details.user_id', '=', 'projects.client_id')
            ->select('users.id', 'client_details.name', 'users.email', 'users.email_notifications', 'users.created_at', 'client_details.company_name', 'users.image')
    ...
    //lọc danh sách clients có archived project
    public static function allClientsWithArchivedProject()
    {
        $clients = ClientDetails::join('users', 'client_details.user_id', '=', 'users.id')
            ->join('projects','client_details.user_id', '=', 'projects.client_id')
            ->select('users.id', 'client_details.name', 'users.email', 'users.email_notifications', 'users.created_at', 'client_details.company_name', 'users.image')
