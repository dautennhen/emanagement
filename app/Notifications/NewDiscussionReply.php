...
class NewDiscussionReply extends Notification implements ShouldQueue
{
...

    {
        return OneSignalMessage::create()
            ->subject(ucwords($this->discussionReply->user->name) . ' '. __('email.discussionReply.subject') . $this->discussionReply->discussion->title)
            ->body(__('email.discussionReply.text') . ' ' . $this->discussionReply->discussion->title );
    }
}
