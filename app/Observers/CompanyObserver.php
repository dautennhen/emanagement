...
class CompanyObserver
{
    ...
    public function created(Company $company)
    {
        ...
        if(is_null($company->locale)){
            $company->locale = global_settings()->new_company_locale;
        }
    ...
    public function addLeadSourceAndLeadStatus($company)
    {
        ...
        //     ['type' => 'in process', 'company_id' => $company->id],
        //     ['type' => 'converted', 'company_id' => $company->id]
        // ];
        $status = [
            ['type' => 'pending', 'company_id' => $company->id, 'priority' => 1, 'default' => 1],
            ['type' => 'in process', 'company_id' => $company->id, 'priority' => 2, 'default' => 1],
            ['type' => 'converted', 'company_id' => $company->id, 'priority' => 3, 'default' => 1]
        ];
