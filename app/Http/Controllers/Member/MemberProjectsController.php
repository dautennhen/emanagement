...
class MemberProjectsController extends MemberBaseController
{
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($projects)
            ...
            ->addColumn('action', function ($row) {
                ...
                $action .= '<li><a href="' . route('member.projects.show', [$row->id]) . '"><i class="fa fa-search" aria-hidden="true"></i>'.ucwords(__('app.viewprojectDetails')).'</a></li>';
    ...
    public function gantt($ganttProjectId = '')
    {
        ...
        $this->projectName=Project::where('projects.id', '=', $ganttProjectId)->first()->project_name;
    ...
    public function ajaxCreate(Request $request, $projectId)
    {
        ...
        $projects = Project::select('projects.*')->where('id',$projectId);
