        ...
        return DataTables::of($notice)
            ->addColumn('action', function($row){
                ...
                $action.= '<a href="javascript:;" class="btn btn-success btn-circle noticeShow"
                  data-toggle="tooltip" data-notice-id="' . $row->id . '" data-original-title="'.ucwords(__('app.view')).'"><i class="fa fa-search" aria-hidden="true"></i></a> ';
                ...
                if($this->user->cans('delete_notice')) {
                    $action .= ' <a href="javascript:;" class="btn btn-danger btn-circle sa-params"
                      data-toggle="tooltip" data-user-id="' . $row->id . '" data-original-title="'.ucwords(__('app.delete')).'"><i class="fa fa-times" aria-hidden="true"></i></a>';
                }
                return $action;
            })
            ->editColumn(
