...
class SuperAdminStripeSettingsController extends SuperAdminBaseController
{
    ...
    public function update(UpdateRequest $request) {
        ...
        $stripe->vnp_TmnCode = $request->vnp_TmnCode;
        $stripe->vnp_HashSecret = $request->vnp_HashSecret;
        // $credential->vnpay_merchant_email = $request->vnpay_merchant_email;
        ($request->vnpay_status) ? $stripe->vnpay_status = 'active' : $stripe->vnpay_status = 'inactive';
    ...
    public function changePaymentMethod(UpdateRequest $request) {
        ...
        $stripe->vnpay_status = ($type === 'vnpay') && $bothUncheck == 'false' ? 'active' : 'inactive';
