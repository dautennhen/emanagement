    ...
    public function data(Request $request, $employeeId = null)
    {
        ...
        return DataTables::of($leaves)
            ...
            ->addColumn('status', function ($row) {
                ...
                return '<div class="label label-' . $label . '">' . mb_convert_case(__('app.'.$row->status),MB_CASE_UPPER,"UTF-8") . '</div>';
            })
            ...
            ->addColumn('action', function ($row) {
                if ($row->status == 'pending') {
                    return '<a href="javascript:;"
                            ...
                            data-toggle="tooltip"
                            data-original-title="' . mb_convert_case(__('app.approved'), MB_CASE_TITLE,"UTF-8") . '">
                            ...
                            data-toggle="tooltip"
                            data-original-title="' .mb_convert_case(__('app.reject'), MB_CASE_TITLE,"UTF-8") . '">
                            ...
                            data-toggle="tooltip"
                            data-original-title="' . mb_convert_case(__('app.details'), MB_CASE_TITLE,"UTF-8") . '">
