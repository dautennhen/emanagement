        ...
        return DataTables::of($paypalData)
            ...
            ->addColumn('action', function ($row) {
                if ($row->method == 'Stripe' && $row->invoice_id) {
                    return '<a href="' . route('admin.stripe.invoice-download', $row->invoice_id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }

                if ($row->method == 'Paypal') {
                    return '<a href="' . route('admin.paypal.invoice-download', $row->id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }

                if ($row->method == 'Razorpay') {
                    return '<a href="' . route('admin.billing.razorpay-invoice-download', $row->id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }

                if ($row->method == 'Offline') {
                    return '<a href="' . route('admin.billing.offline-invoice-download', $row->id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }

                if ($row->method == 'Paystack') {
                    return '<a href="' . route('admin.billing.paystack-invoice-download', $row->id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }

                if ($row->method == 'Mollie') {
                    return '<a href="' . route('admin.billing.mollie-invoice-download', $row->id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }

                if ($row->method == 'Authorize') {
                    return '<a href="' . route('admin.billing.authorize-invoice-download', $row->id) . '" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" data-original-title="'.__('app.download').'"><span></span> <i class="fa fa-download"></i></a>';
                }
