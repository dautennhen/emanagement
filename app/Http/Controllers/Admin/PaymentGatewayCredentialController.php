...
class PaymentGatewayCredentialController extends AdminBaseController
{
    ...
    public function update(UpdateGatewayCredentials $request, $id)
    {
        ...
        $credential->vnp_TmnCode = $request->vnp_TmnCode;
        $credential->vnp_HashSecret = $request->vnp_HashSecret;
        // $credential->vnpay_merchant_email = $request->vnpay_merchant_email;
        ($request->vnpay_status) ? $credential->vnpay_status = 'active' : $credential->vnpay_status = 'inactive';
