...
class ManageProjectsController extends AdminBaseController
{
    ...
    public function index(ProjectsDataTable $dataTable)
    {
        ...
        $this->clients = User::allClientsWithProject();
    ...
    public function archive()
    {
        ...
        // $this->clients = User::allClients();
        $this->clients = User::allClientsWithArchivedProject();
        ...
        return DataTables::of($projects)
            ->addColumn('action', function ($row) {
                return '
                      ...
                      data-toggle="tooltip" data-user-id="' . $row->id . '" data-original-title="'.__('app.restore').'"><i class="fa fa-undo" aria-hidden="true"></i></a>
