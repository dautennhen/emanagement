    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($leaves)
            ...
            ->addColumn('approve', function ($row) {
                ...
                <a href="javascript:;" class="view-approve" data-pk="' . $row->id . '">'.__('app.view').'</a>';
            })
            ->addColumn('pending', function ($row) {
                ...
                <a href="javascript:;" data-pk="' . $row->id . '" class="view-pending">'.__('app.view').'</a>';
            })
            ->addColumn('upcoming', function ($row) {
                ...
                <a href="javascript:;" data-pk="' . $row->id . '" class="view-upcoming">'.__('app.view').'</a>';
            })
            ->addColumn('action', function ($row) {
                return '<a  href="javascript:;" data-pk="' . $row->id . '"  class="btn btn-info btn-sm exportUserData"
                      data-toggle="tooltip" data-original-title="'.ucwords(__('app.Exporttoexcel')).'"><i class="ti-export" aria-hidden="true"></i> Export</a>';
            })
            ->addIndexColumn()
