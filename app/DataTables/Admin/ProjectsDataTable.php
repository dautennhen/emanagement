...
class ProjectsDataTable extends BaseDataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                <ul role="menu" class="dropdown-menu pull-right">
                  ...
                  <li><a href="' . route('admin.projects.show', [$row->id]) . '"><i class="fa fa-search" aria-hidden="true"></i> ' . trans('app.details') . '</a></li>
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.completion') => ['data' => 'completion_percent', 'name' => 'completion_percent', 'exportable' => false],
