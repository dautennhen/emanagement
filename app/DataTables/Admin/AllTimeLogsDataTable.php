        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                if (!is_null($row->end_time)) {
                    ...
                    data-toggle="tooltip" data-time-id="' . $row->id . '"  ><i class="fa fa-pencil" aria-hidden="true"></i> ' . trans('app.edit') . '</a></li>
                    <li> <a href="javascript:;" class="sa-params"
                    data-toggle="tooltip" data-time-id="' . $row->id . '" ><i class="fa fa-times" aria-hidden="true"></i> ' . trans('app.delete') . '</a></li>';
