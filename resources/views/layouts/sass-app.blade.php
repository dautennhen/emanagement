...
<head>
    ...
    <meta property="og:image" content="{{ $setting->logo_front_url }}" />
...
})(window,document,'script','dataLayer','GTM-WJWPNT9');</script>
<!-- End Google Tag Manager -->
</head>

<body id="home">
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WJWPNT9"
...
s1.async=true;
s1.src='https://embed.tawk.to/5f54c488f0e7167d000dd2ff/default';
s1.charset='UTF-8';
