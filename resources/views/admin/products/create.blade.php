                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="multiselect" name="tax[]" title="{{ mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}"  multiple="multiple" class="selectpicker form-control type">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            <input id="purchase_allow" name="purchase_allow" value="no"
                                                   type="checkbox">
                                            <label for="purchase_allow">{{ ucwords(__('app.purchaseAllow')) }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
