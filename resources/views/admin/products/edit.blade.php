                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="multiselect" name="tax[]"  multiple="multiple" title="{{ mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}" class="selectpicker form-control type">
