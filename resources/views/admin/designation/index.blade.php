                    ...
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="users-table">
                        ...
                        @forelse($groups as $group)
                            <tr id="group{{ $group->id }}">
                                ...
                                <td>{{ ucfirst($group->name) }} <label class="label label-success">{{ sizeof($group->members) }} @lang('modules.projects.members')</label></td>
                                <td>
        ...
        $(function() {
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    text: "{{ mb_convert_case(__('app.ask.Youwillnotbeabletorecoverthedeleteddesignation'), MB_CASE_TITLE, "UTF-8") }}",
                    type: "warning",
