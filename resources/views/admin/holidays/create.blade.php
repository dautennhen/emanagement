            ...
            <div id="addMoreBox1" class="clearfix">
                ...
                <div class="col-md-5" style="margin-left: 5px;">
                    <div class="form-group" id="occasionBox">
                        <input class="form-control"  type="text" name="occasion[0]" placeholder="@lang('app.occasion')"/>
...
<script>
    ...
    $('#plusButton').click(function(){
        ...
        $(' <div id="addMoreBox'+indexs+'" class="clearfix"> ' +
            '<div class="col-md-5"><div class="form-group "><input autocomplete="off" class="form-control date-picker'+$i+'" id="dateField'+indexs+'" name="date['+$i+']" data-date-format="dd/mm/yyyy" type="text" value="" placeholder="@lang('app.date')"/></div></div>' +
            '<div class="col-md-5 "style="margin-left:5px;"><div class="form-group"><input class="form-control " name="occasion['+$i+']" type="text" value="" placeholder="@lang('app.occasion')"/></div></div>' +
