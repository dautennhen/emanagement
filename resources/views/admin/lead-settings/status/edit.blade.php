            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="type" id="defaultType" value="{{ $status->type }}" class="form-control" disabled>
...
<script>
//sau này rút gọn code sau
    if ($('#type').val()=='pending'||$('#type').val()=='in process'||$('#type').val()=='converted'){
        $('#defaultType').attr('type', 'text');
