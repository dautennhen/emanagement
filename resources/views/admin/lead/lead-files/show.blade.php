                                ...
                                <div class="col-md-12" id="files-list-panel">
                                    <div class="white-box">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist" id="list-tabs">
                                            <li role="presentation" class="active nav-item" data-pk="list"><a href="#list" class="nav-link list" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"> List</span></a></li>
...
//        maxFilesize: 2, // MB,
 ...
 // đây là cái dòng mồ hôi xương máu, mất gần 1 ngày chỉ với 3 dòng code
