                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{{ ucwords(__('modules.lead.companyName')) }}</label>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label">{{ mb_convert_case(__('app.address'), MB_CASE_TITLE,"UTF-8") }}</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label for="">{{ ucwords(__('modules.tickets.chooseAgents')) }} <a href="javascript:;"
                                                                                              id="addLeadAgent"
                                                                                              class="btn btn-sm btn-outline btn-success"><i
                                                        class="fa fa-plus"></i> {{ ucwords(__('app.add')) }} {{ ucwords(__('app.leadAgent')) }}</a></label>
                                        <select class="select2 form-control" data-placeholder="{{ ucwords(__('modules.tickets.chooseAgents')) }}" id="agent_id" name="agent_id">
                                            <option value="">{{ ucwords(__('modules.tickets.chooseAgents')) }}</option>
                                            @foreach($leadAgents as $emp)
                                                <option  @if($emp->id == $lead->agent_id) selected @endif  value="{{ $emp->id }}">{{ ucwords($emp->user->name) }} @if($emp->user->id == $user->id)
                                                        ({{ mb_convert_case(__('app.you'),MB_CASE_UPPER,"UTF-8") }}) @endif</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
