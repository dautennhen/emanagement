                                ...
                                <li id="dp_{{$users->id}}" class="bg-white">
                                    ...
                                    onclick="getChatData('{{$users->id}}', '{{$users->name}}')">
                                        ...
                                        <span @if($users->message_seen == 'no' && $users->user_one != $user->id) class="font-bold" @endif> {{$users->name}}
                                            <small class="text-simple"> @if($users->last_message){{  ucwords(\Carbon\Carbon::parse($users->last_message)->diffForHumans())}} @endif
                                                ...
                                                @elseif(\App\User::isClient($users->id))
                                                    <label class="btn btn-success btn-xs btn-outline">{{ ucwords(__('app.menu.clients')) }}</label>
                                                @else
