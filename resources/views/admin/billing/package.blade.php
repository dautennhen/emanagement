...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="white-box ">
                <h3>{{ ucwords(__('app.monthlypackages')) }}</h3>
                <div class="table-responsive table-responsive-froid">
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tr>
                            <td>{{ ucwords(__('app.menu.fileStorage')) }}</td>
                            @foreach($packages as $package)
                        ...
                        @foreach($moduleArray as $key => $module)
                            <tr>
                                <td>
                                    @php
                                        $moduleNameNew = strval("app.menu.$key");
                                        $trans = ucwords(__($moduleNameNew));
                                    @endphp
                                    @if(is_string($trans))
                                        {{$trans}}
                                    @else
                ...
                <h1 class="m-t-20">{{ ucwords(__('app.annualpackages')) }}</h1>
                <div class="table-responsive table-responsive-froid">
                    <table class="table table-hover table-bordered text-center">
                        <thead>
                        <tr class="active">
