                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="select2 select2-multiple " multiple="multiple"
                                        data-placeholder="{{ ucwords(__('modules.client.choose skills')) }}" name="skill[]" id="skill" data-style="form-control">
                                    <option value="all">@lang('modules.client.all')</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="department" id="department" data-style="form-control">
                                    ...
                                    @forelse($departments as $department)
                                        {{-- <option value="{{$department->id}}">{{ __('app.menu.' .strtolower(str_replace(' ','',($department->team_name)))) }}</option> --}}
    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                text: "{{ mb_convert_case(__('app.ask.Youwillnotbeabletorecoverthedeleteduser'), MB_CASE_TITLE, "UTF-8") }}",
                type: "warning",
