                                ...
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body b-all border-radius">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 text-center">
                                                <a href="javascript:;" class="btn p-t-15 text-info" data-toggle="modal" data-target="#project-notes-modal"><i class="ti-arrows-vertical"></i> @lang('app.expand')</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--Ajax Modal--}}
<div class="modal fade bs-modal-lg in" id="project-notes-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="icon-layers"></i> @lang('app.note')</h4>
            </div>
            <div class="modal-body">
                {!! $project->notes !!}
            </div>
