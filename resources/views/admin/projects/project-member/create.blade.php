                        ...
                        <section id="section-line-2" class="show">
                            <div class="white-box">
                                ...
                                <ul class="nav nav-tabs" role="tablist" id="list-tabs">
                                    <li role="presentation" class="active nav-item" data-pk="add-member">
                                        <a href="#add-member" class="nav-link" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true">
                                    ...
                                    <li role="presentation" class="nav-item" data-pk="add-team"><a href="#add-team" class="nav-link" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">@lang('app.add') @lang('app.team')</span></a></li>
                                </ul>
                                {{-- Tab panes --}}
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="add-member">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="add-team">
                                        <div class="panel panel-inverse">
...
$('body').on('click', '.delete-members', function(){
    ...
    swal({
        ...
        text: "{{ mb_convert_case(__('app.ask.Thiswillremovethememberfromtheproject'), MB_CASE_TITLE, "UTF-8") }}",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#DD6B55",
        confirmButtonText: "{{ __('app.ask.Yes') }}",
...
$('#list-tabs').on("shown.bs.tab",function(event){
        var tabSwitch = $('#add-member').hasClass('active');
        if(tabSwitch == true) {
            $('#view').val('add-member');
        } else {
            $('#view').val('add-team');
