                    ...
                    <div class="content-wrap">
                        <section id="section-line-3" class="show">
                            ...
                            <div class="container-scroll white-box">
                                ...
                                <button class="btn btn-default btn-outline btn-sm pull-right" id="my-tasks"><i class="fa fa-user"></i> @lang('app.MyTasks')</button>
                                <button class="btn btn-default btn-outline btn-sm pull-right" id="show-all-tasks" style="display: none"><i class="fa fa-users"></i> {{ ucwords(__('app.ShowAll')) }}</button>
