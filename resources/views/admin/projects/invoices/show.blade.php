                                                ...
                                                <li class="list-group-item">
                                                    <div class="row">
                                                            ...
                                                            @else
                                                                @if ($invoice->status == 'unpaid')
                                                                    <label class="label label-danger">
                                                                        {{-- @lang('unpaid') --}}
                                                                        {{ mb_convert_case(__('modules.invoices.'.$invoice->status), MB_CASE_UPPER, "UTF-8") }}
                                                                    </label>
                                                        ...
                                                        <div class="col-sm-3 col-xs-12">
                                                            ...
                                                            <a href="{{ route('admin.invoices.download', $invoice->id) }}" data-toggle="tooltip" data-original-title="{{ ucwords(__('app.download')) }}" class="btn btn-default btn-circle m-l-10"><i class="fa fa-download"></i></a>
                                                        </div>
                                                    </div>
                                                </li>
                                            @empty
