...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="{{ route('admin.ticket-agents.index') }}" class="btn btn-sm btn-inverse btn-outline"><i class="fa fa-gear"></i> {{ ucwords(__('app.menu.ticketSettings')) }}</a>
            <a href="{{ route('admin.tickets.create') }}"
                               class="btn btn-success btn-outline btn-sm">{{ ucwords(__('modules.tickets.addTicket')) }} <i class="fa fa-plus"
                ...
                <div class="col-md-12">
                    <div class="white-box p-t-10 p-b-10">
                        ...
                        <ul class="list-inline text-right">
                            <li>
                                <h5><i class="fa fa-circle m-r-5" style="color: #4c5667;"></i>{{ ucwords(__('modules.invoices.total')) }}</h5>
                            </li>
                            <li>
                                <h5><i class="fa fa-circle m-r-5" style="color: #5475ed;"></i>{{ ucwords(__('modules.issues.resolved')) }}</h5>
                            </li>
                            <li>
                                <h5><i class="fa fa-circle m-r-5" style="color: #f1c411;"></i>{{ ucwords(__('modules.tickets.totalUnresolvedTickets')) }}</h5>
                            </li>
                        </ul>
