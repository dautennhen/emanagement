                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option @if($expense->status == 'approved') selected @endif >{{ mb_convert_case(__('app.approved'),MB_CASE_TITLE,"UTF-8") }}
                                            </option>
                                            <option @if($expense->status == 'pending') selected @endif>{{ mb_convert_case(__('app.pending'),MB_CASE_TITLE,"UTF-8") }}</option>
                                            <option @if($expense->status == 'rejected') selected @endif>{{ mb_convert_case(__('app.rejected'),MB_CASE_TITLE,"UTF-8") }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
