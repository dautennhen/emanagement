            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {!! Form::open(['id'=>'createExpense','class'=>'ajax-form','method'=>'POST','route'=>['admin.expenses.store']]) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12 ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="required control-label">@lang('app.invoice')</label>
                                        ...
                                        {{-- @if ($errors->has('bill'))
                                            <div class="help-block with-errors">{{ $errors->first('bill') }}</div>
                                        @endif --}}
                                    </div>
                                </div>
                            </div>
