                ...
                <div class="form-group">
                    ...
                    <p>
                        @if ($expense->status == 'pending')
                            <label class="label label-warning">{{ mb_convert_case(__('app.'.$expense->status),MB_CASE_UPPER,"UTF-8") }}</label>
                        @elseif ($expense->status == 'approved')
                            <label class="label label-success">{{ mb_convert_case(__('app.'.$expense->status),MB_CASE_UPPER,"UTF-8") }}</label>
                        @else
                            <label class="label label-danger">{{ mb_convert_case(__('app.'.$expense->status),MB_CASE_UPPER,"UTF-8") }}</label>
                        @endif
                    </p>
                </div>
            </div>
