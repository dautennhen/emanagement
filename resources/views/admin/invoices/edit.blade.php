                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 m-t-5">
                                    <button type="button" class="btn btn-info" id="add-item"><i class="fa fa-plus"></i>
                                        {{ ucwords(__('modules.invoices.addItem')) }}
                                    </button>
                                </div>
...
<script>
    ...
    $('#add-item').click(function () {
        ...
        var item = '<div class="col-xs-12 item-row margin-top-5">'
            ...
            +'<select id="multiselect'+i+'" name="taxes['+i+'][]" title="{{  mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}" value="null"  multiple="multiple" class="selectpicker form-control type">'
                @foreach($taxes as $tax)
