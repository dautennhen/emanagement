                                        ...
                                        <div class="col-xs-12 item-row margin-top-5">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="" style="display: none" name="taxes[{{ $key }}][]" title="{{ mb_convert_case(__('app.Nothingselected'),MB_CASE_TITLE,"UTF-8") }}"  multiple="multiple" class=" form-control type">
                                                    ...
                                                    <select id="multiselect" disabled  multiple="multiple" title="{{ mb_convert_case(__('app.Nothingselected'),MB_CASE_TITLE,"UTF-8") }}" class="selectpicker form-control type">
                                                        @foreach($taxes as $tax)
                                                            <option data-rate="{{ $tax->rate_percent }}"
                                                                    @if (isset($item->taxes) && array_search($tax->id, json_decode($item->taxes)) !== false)
                                                                    selected
...
<script>
    ...
    $('#add-item').click(function () {
        ...
        var item = '<div class="col-xs-12 item-row margin-top-5">'+
            ...
            +'<select id="multiselect'+i+'" name="taxes['+i+'][]" value="null" title="{{ mb_convert_case(__('app.Nothingselected'),MB_CASE_TITLE,"UTF-8") }}"  multiple="multiple" class="selectpicker form-control type">'
                @foreach($taxes as $tax)
