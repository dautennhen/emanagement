...
<script src="{{ asset('plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.js') }}" charset="UTF-8"></script>
...
<script>
    ...
    $('body').on('click', '.reminderButton', function(){
        ...
        swal({
            ...
            text: "{{ mb_convert_case(__('app.ask.Doyouwanttosendremindertoassignedclient'),MB_CASE_TITLE,"UTF-8") }}",
            type: "warning",
    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                text: "{{ mb_convert_case(__('app.ask.Youwillnotbeabletorecoverthedeletedinvoice'), MB_CASE_TITLE,"UTF-8") }}",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                confirmButtonText: "@lang('app.ask.Yes,deleteit')",
        ...
        $('body').on('click', '.unpaidAndPartialPaidCreditNote', function(){
            ...
            swal({
                ...
                title:"{{ ucwords(__('app.ask.Areyousurethatyouwanttocreatethecreditnote')) }}",
                // text: "When creating credit note from non paid invoice, the credit note amount will get applied for this invoice.",
                text: "{{ mb_convert_case(__('app.ask.Whencreatingcreditnotefromnonpaidinvoice,thecreditnoteamountwillgetappliedforthisinvoice'),MB_CASE_TITLE,"UTF-8") }}",
                type: "info",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                confirmButtonText: "@lang('app.ask.Yes,deleteit')",
    ...
    $('body').on('click', '.sa-cancel', function(){
        ...
        swal({
            ...
            text: "{{ mb_convert_case(__('app.ask.Doyouwanttochangeinvoiceincanceled'), MB_CASE_TITLE,"UTF-8") }}",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "@lang('app.ask.Yes,deleteit')",
