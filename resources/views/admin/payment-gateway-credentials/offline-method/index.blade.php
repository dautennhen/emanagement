...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ strtoupper(__($pageTitle)) }}</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                                                    ...
                                                    <td colspan="5" class="text-center">
                                                        <div class="empty-space" style="height: 200px;">
                                                            <div class="empty-space-inner">
                                                                ...
                                                                <div class="subtitle">
                                                                    <a href="javascript:;" id="addMethod" class="btn btn-outline btn-success btn-sm addMethod">{{ ucwords(__('modules.offlinePayment.addMethod')) }} <i class="fa fa-plus" aria-hidden="true"></i></a>
