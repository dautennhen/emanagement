                        ...
                        <section id="section-line-3" class="show">
                            <div class="row">
                                <div class="col-md-12" id="files-list-panel">
                                    <div class="white-box">
                                        <h2>{{ ucwords(__('modules.proposal.title')) }}</h2>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <a href="{{ route('admin.proposals.create') }}/{{$lead->id}}" class="btn btn-outline btn-success btn-sm">{{ mb_convert_case(__('modules.proposal.createTitle'), MB_CASE_TITLE, "UTF-8") }} <i class="fa fa-plus" aria-hidden="true"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
