                                        ...
                                        <div class="col-xs-12 item-row margin-top-5">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="multiselect" name="taxes[{{ $key }}][]" title="{{ mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}"  multiple="multiple" class="selectpicker form-control type">
