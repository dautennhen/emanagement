                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group" >
                                        <label class="control-label">{{ ucwords(__('modules.lead.lead')) }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">{{ ucwords(__('modules.invoices.currency')) }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">{{ ucwords(__('modules.estimates.validTill')) }}</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">{{ mb_convert_case(__('app.note'), MB_CASE_TITLE, "UTF-8") }}</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group m-b-10">
                                        ...
                                        <ul role="menu" class="dropdown-menu dropdown-content" style="width:300px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12  visible-md visible-lg">
                                    ...
                                    <div class="col-md-1 font-bold" style="padding: 8px 15px">
                                        {{ mb_convert_case(__('modules.invoices.qty'), MB_CASE_TITLE, "UTF-8") }}
                                    </div>

                                    <div class="col-md-2 font-bold" style="padding: 8px 15px">
                                        {{ ucwords(__('modules.invoices.unitPrice')) }}
                                    </div>
                                    ...
                                    <div class="col-md-2 text-center font-bold" style="padding: 8px 15px">
                                        {{ ucwords(__('modules.invoices.amount')) }}
                                    </div>
                                    ...
                                    <div class="col-xs-12 item-row margin-top-5">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <textarea name="item_summary[]" class="form-control" placeholder="{{ ucwords(__('app.description')) }}" rows="2"></textarea>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select id="multiselect" name="taxes[0][]" title="{{ mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}" multiple="multiple" class="selectpicker form-control type">
                                ...
                                <div class="col-xs-12 m-t-5">
                                    <button type="button" class="btn btn-info" id="add-item"><i class="fa fa-plus"></i> {{ ucwords(__('modules.invoices.addItem')) }}</button>
                                </div>

                                <div class="col-xs-12 ">
                                    <div class="row">
                                        <div class="col-md-offset-9 col-xs-6 col-md-1 text-right p-t-10" >{{ mb_convert_case(__('modules.invoices.subTotal'), MB_CASE_TITLE, "UTF-8") }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-9 col-md-1 text-right p-t-10">
                                            {{ ucwords(__('modules.invoices.discount')) }}
                                        </div>
                                    ...
                                    <div class="row m-t-5 font-bold">
                                        <div class="col-md-offset-9 col-md-1 col-xs-6 text-right p-t-10" >{{ ucwords(__('modules.invoices.total')) }}</div>
...
<script>
    ...
    $('#add-item').click(function () {
        ...
        var item = '<div class="col-xs-12 item-row margin-top-5">'
            ...
            +'<select id="multiselect'+i+'" name="taxes['+i+'][]" title="{{ mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}"  multiple="multiple" class="selectpicker form-control type">'
                @foreach($taxes as $tax)
            +'<option data-rate="{{ $tax->rate_percent }}" value="{{ $tax->id }}">{{ $tax->tax_name.': '.$tax->rate_percent }}%</option>'
                @endforeach
            +'</select>'
    ...
    $('.add-product').on('click', function(event) {
        ...
        $.easyAjax({
            ...
            success: function(response) {
                ...
                itemRow.attr('title', '{{ mb_convert_case(__('app.Nothingselected'), MB_CASE_TITLE, "UTF-8") }}');
