                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($currencies as $currency)
                                                    <tr>
                                                        <td>{{ ucwords($currency->currency_name) }} {!! ($global->currency_id == $currency->id) ? '<label class="label label-success">'.mb_strtoupper(__('app.DEFAULT'),'UTF-8').'</label>' : "" !!}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @endphp
                                                            <span class="label {{ $class }}">{{ ucfirst(__('app.'.$currency->status)) }}</span>
                                                        </td>
                                                        <td class="text-nowrap">
                                                            <a href="{{ route('admin.currency.edit', [$currency->id]) }}"
                                                               class="btn btn-info btn-circle"
                                                               data-toggle="tooltip" data-original-title="{{ucwords(__('app.edit'))}}"><i
