<div id="event-detail">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="form-group">
                        <label>{{ mb_convert_case(__('app.reasonreject'), MB_CASE_TITLE, "UTF-8") }} ? ({{ mb_convert_case(__('app.optional'), MB_CASE_TITLE, "UTF-8") }})</label>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger save-event waves-effect waves-light"> {{ mb_convert_case(__('app.reject'), MB_CASE_TITLE, "UTF-8") }}
        </button>
    </div>
