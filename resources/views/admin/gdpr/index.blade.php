                ...
                <div class="vtabs customvtab m-t-10">
                    ...
                    <div class="tab-content">
                        <div id="vhome3" class="tab-pane active">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="box-title m-b-0">{{ ucwords(__('app.GeneralGDPRSettings')) }}</h3>
                                    <div class="row b-t m-t-20 p-10">
                                        <div class="col-md-12">
                                            {!! Form::open(['id'=>'editSettings','class'=>'ajax-form','method'=>'POST']) !!}
                                            <label for="">{{ucwords(__('app.enable'))}} GDPR</label>
                                            <div class="form-group">
                                                <label class="radio-inline">
                                                    <input type="radio"
                                                           class="checkbox"
                                                           @if($gdprSetting->enable_gdpr) checked @endif
                                                           value="1" name="enable_gdpr">{{ucwords(__('app.yes'))}}
                                                </label>
                                                <label class="radio-inline m-l-10">
                                                    <input type="radio"
                                                           @if($gdprSetting->enable_gdpr==0) checked @endif
                                                           value="0" name="enable_gdpr">{{ucwords(__('app.no'))}}
                                                </label>


                                            </div>
                                            <hr>
                                            <label for="">{{ucwords(__('app.ShowGDPRlinkincustomersareanavigation'))}}</label>
                                            <div class="form-group">
                                                <label class="radio-inline">
                                                    <input type="radio"
                                                           class="checkbox"
                                                           @if($gdprSetting->show_customer_area==1) checked @endif
                                                           value="1" name="show_customer_area">{{ucwords(__('app.yes'))}}
                                                </label>
                                                <label class="radio-inline m-l-10">
                                                    <input type="radio"
                                                           @if($gdprSetting->show_customer_area==0) checked @endif
                                                           value="0" name="show_customer_area">{{ucwords(__('app.no'))}}
                                                </label>


                                            </div> <hr>
                                            <label for="">{{ ucwords(__('app.ShowGDPRlinkincustomersareafooter')) }}</label>
                                            <div class="form-group">
                                                <label class="radio-inline">
                                                    <input type="radio"
                                                           class="checkbox"
                                                           @if($gdprSetting->show_customer_footer==1) checked @endif
                                                           value="1" name="show_customer_footer">{{ucwords(__('app.yes'))}}
                                                </label>
                                                <label class="radio-inline m-l-10">
                                                    <input type="radio"
                                                           @if($gdprSetting->show_customer_footer==0) checked @endif
                                                           value="0" name="show_customer_footer">{{ucwords(__('app.no'))}}
                                                </label>


                                            </div>
                                            <hr>
                                            <label for="">{{ ucwords(__('app.GDPRpagetopinformationblock')) }}</label>
                                            <div class="form-group">
