                    ...
                    <div class="tab-content">
                        <div id="vhome3" class="tab-pane active">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="add-field" class="btn btn-success btn-outline"><i class="fa fa-plus"></i> {{ ucwords(__('modules.customFields.addField')) }}
                                            </button>
                                        </div>
                                    </div>
