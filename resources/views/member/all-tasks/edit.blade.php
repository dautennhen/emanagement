                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            @foreach($taskBoardColumns as $taskBoardColumn)
                                                <option @if($task->board_column_id == $taskBoardColumn->id) selected @endif value="{{$taskBoardColumn->id}}">@if($taskBoardColumn->column_name=='Complete'||$taskBoardColumn->column_name=='Completed'||$taskBoardColumn->column_name=='Incomplete'){{ mb_convert_case(__('app.'.$taskBoardColumn->column_name),MB_CASE_TITLE,"UTF-8") }}@else{{ $taskBoardColumn->column_name }}@endif</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
<script>
    ...
    @if($upload)
        ...
        //event complete nhận cả khi upload success và fail
