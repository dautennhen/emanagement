...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ mb_strtoupper(__($pageTitle), 'UTF-8') }}</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="col-md-4 show" id="new-follow-panel" style="">
            <div class="panel panel-default">
                <div class="panel-heading "><i class="ti-calendar"></i> <span id="currentMonthName">New</span> @lang('app.menu.holiday')  <div class="panel-action">
                    </div>
                </div>
                <div class="panel-wrapper collapse in">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th>{{ ucwords(__('app.date')) }}</th>
                            <th>{{ ucwords(__('app.occassion')) }}</th>
                        </tr>
                        </thead>
...
<script>
    const monthNames = ["@lang('app.january')", "@lang('app.february')", "@lang('app.march')", "@lang('app.april')", "@lang('app.may')", "@lang('app.june')",
        "@lang('app.july')", "@lang('app.august')", "@lang('app.september')", "@lang('app.october')", "@lang('app.november')", "@lang('app.december')"
    ];
