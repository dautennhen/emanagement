        ...
        <div class="col-md-12 m-b-30">
            <div class="white-box">
                <div class="col-md-4 text-center">
                    <h4><span class="text-dark totalLeads">{{ $totalLeads }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalLeads')</span></h4>
                </div>
                <div class="col-md-4 text-center b-l">
                    <h4><span class="text-info totalClientConverted">{{ $totalClientConverted }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalConvertedClient')</span></h4>
                </div>
                <div class="col-md-4 text-center b-l">
                    <h4><span class="text-warning pendingLeadFollowUps">{{ $pendingLeadFollowUps }}</span> <span class="font-12 text-muted m-l-5"> @lang('modules.dashboard.totalPendingFollowUps')</span></h4>
                </div>
            </div>
        </div>
                        ...
                        <form action="" id="filter-form">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" name="client" id="client" data-style="form-control">
                                        ...
                                        <option value="lead" selected>@lang('modules.lead.lead')</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select disabled class="selectpicker form-control" data-placeholder="@lang('modules.tickets.chooseAgents')" id="agent_id" name="agent_id">
                                        {{-- <option value="all">@lang('modules.lead.all')</option> --}}
                    
                                        @foreach($leadAgents as $emp)
                                            @if($emp->user->id == $user->id)
                                                <option value="{{ $emp->id }}" selected>{{ ucwords($emp->user->name) }} @if($emp->user->id == $user->id)
                                                        (YOU) @endif</option>
                                            @endif
                                        @endforeach
                                    </select>
