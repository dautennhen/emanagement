                ...
                <div class="panel-heading"> @lang('modules.projects.createTitle')
                    <div class="pull-right">
                        <div class="btn-group m-r-10">
                            <button aria-expanded="true" data-toggle="dropdown" id="thinh" class="btn btn-block btn-outline btn-info waves-effect dropdown-toggle waves-light" type="button">@lang('app.menu.template') <span class="caret"></span></button>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group" id="user_id">
                                        ...
                                        <select class="select2 m-b-10 select2-multiple template-member" multiple="multiple"
...
<script>
    ...
    function getMembers(id, callback){
         $.ajax({
            ...
            url: '/member/project-template-get-member/'+id,
            data: {},
            type: 'GET',
            beforeSend: function () {},
            complete: function () {},
    ...
    function setTemplate(id){
        ...
        if(id != null && id != undefined && id != ""){
            ...
            getMembers(id, function(response){
                var values = [];
                $.each(response, function( index, obj ) {
                    values[index] = obj.user_id
                });
                $('.template-member.select2-multiple').val(values).trigger('change');
            })
