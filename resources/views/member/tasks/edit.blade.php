                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <select class="select2 select2-multiple" multiple="multiple"  name="user_id[]" id="user_id2">
...
<script>
    ...
    function updateTask(){
        ...
        // if(user_id2===null){
        //     $('#help-block').addClass("help-block");
        //     $('#assignTo').addClass("has-error");
        //     // $('#user_id2').css('border','1px solid #fb9678');
        //     // $('#help-block').css('color','red');
        //     $('#help-block').html('Choose an assignee');
        //     return true;
        // }
        $.easyAjax({
