                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" autocomplete="off" name="start_date" id="start_date2" class="form-control" value="">
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" autocomplete="off" name="due_date" id="due_date"
                                                                               class="form-control">
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
...
<script type="text/javascript">
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        var buttons = {
            cancel: "@lang('app.ask.No,cancelplease')",
            confirm: {
                text: "@lang('app.ask.Yes,deleteit')",
                value: 'confirm',
                visible: true,
                className: "danger",
            }
        ...
        swal({
            ...
            text: "{{ mb_convert_case(__('app.ask.Youwillnotbeabletorecoverthedeletedtask'),MB_CASE_TITLE,"UTF-8") }}",
            dangerMode: true,
            icon: 'warning',
            buttons: buttons
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('#save-task').click(function () {
        console.log($('#createTask').serialize());
        // return true;
        $.easyAjax({
