    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> {{ ucfirst(__('app.productpurchase')) }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group m-b-10">
                                        <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">{{ ucwords(__('app.menu.products')) }} <span class="caret"></span></button>
                                                ...
                                                <li class="m-b-10">
                                                    <div class="row m-t-10">
                                                        ...
                                                        <div class="col-md-6" style="text-align: right;padding-right: 30px;">
                                                            <a href="javascript:;" data-pk="{{ $product->id }}" class="btn btn-success btn btn-outline btn-xs waves-effect add-product">{{ ucwords(__('app.add')) }} <i class="fa fa-plus" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </li>
                                            @empty
