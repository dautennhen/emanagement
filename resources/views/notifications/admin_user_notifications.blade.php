<li>
    ...
    @forelse ($user->unreadNotifications as $notification)
        @if(view()->exists('notifications.admin.'.\Illuminate\Support\Str::snake(class_basename($notification->type))))
            @include('notifications.admin.'.\Illuminate\Support\Str::snake(class_basename($notification->type)))
        @endif
    @empty
