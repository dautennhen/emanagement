                        ...
                        <div class="form-group removeable">
                            <div>
                                <div class="email">
                                    ...
                                    <button class="domain-text btn btn-info btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" onclick="confirm();return false;">@lang('app.submit')</button>
                                </div>
                            </div>
                        </div>
                    </div>
